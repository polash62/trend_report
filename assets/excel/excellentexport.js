...
var ExcellentExport = (function () {
    ...
    var ee = {
        /** @expose */
        excel: function (anchor, table, name,program_id,activity_id,activity_code, details) {
            var urltext = '';
            var ctx = '';
            var hrefvalue = '';
            var   formdata={
          ...
          if (program_id !== '4040') {
              ...
              /*
               $.ajax({
                    type: "POST",
                    url: urltext,
                    data: 'activity_id=' + activity_id + '&program_id=' + program_id,
            ...
            $.ajax({
                ...
                hrefvalue = uri.excel + base64(format(template.excel, ctx));
